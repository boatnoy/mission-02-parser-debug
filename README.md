...
**เช้าวันที่ 8 มกราคม 2026** — อัพเดต Claude Code เป็น version 2.1.1 ตามปกติ
...
ไล่หาสาเหตุ... ลอง fix 50 ไฟล์... ยังพัง ลอง disable plugins... ยังพัง ลอง clear cache... ยังพัง

จนกระทั่งใช้วิธี **isolate ทั้งหมด** แล้ว binary search กลับมาทีละ batch

**10 นาทีต่อมา** — เจอแล้ว! 6 ไฟล์ที่มีปัญหา

นี่คือที่มาของ **Challenge นี้** — คุณจะหาเจอได้เร็วกว่าเราไหม?
